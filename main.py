...
from config import LOGGER, DATA_PATH, SEED, TRANSFORMS, NUM_CHANNELS, LEFT_SIDE, RIGHT_SIDE, DELTA, BS, NUM_EPOCHS, DEVICE
...
if __name__ == '__main__':
    ...
    dataset = ImageDataset(path=DATA_PATH,
    ...
    LOGGER.debug(f'Dataset size: {len_dataset}, train size: {train_size}, test size: {test_size}')
